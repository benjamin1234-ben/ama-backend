...
<svg width="750px" height="306px" viewBox="0 0 750 306" version="1.1" xmlns="http://www.w3.org/2000/svg" >
    <g id="Embed-SVG-to-Generate" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        ...
        <text id="AMADAO-VERIFIED-SPON" className={ ibm.className } fontSize="36" fontWeight="normal" letterSpacing="0.33882336" fill="#FFFFFF">
            <tspan x="90.703531" y="281">AMADAO VERIFIED SPONSOR </tspan>
        </text>
        <g id="Group" transform="translate(267.927486, 12.921477)">
            <text id="🌳" className={ apple.className } fontSize="160" fontWeight="normal" line-spacing="200" letterSpacing="1.5058816" fill="#000000">
                <tspan x="-10.072514" y="182.078523">🌳</tspan>
            </text>
            <polygon id="Hexagon-Copy" stroke="#454545" strokeWidth="4" strokeLinecap="square" transform="translate(99.946770, 113.332229) rotate(-1.084576) translate(-99.946770, -113.332229) " points="3.94315844 55.7392 101.533365 1.83222873 197.800566 60.9821263 195.721505 170.801294 97.3678081 224.832229 2.09297276 167.135581"></polygon>
        </g>
        <text id="CO2-Offset" className={ ibm.className } fontSize="90" fontWeight="normal" line-spacing="70" fill="#0A0615">
        ...
        <text id="2,365-Tons" className={ ibm.className } fontSize="90" fontWeight="normal" line-spacing="70" fill="#0A0615">
            <tspan x="511" y="130">{data.height}</tspan>
