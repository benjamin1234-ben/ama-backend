...
import Tree from './HexagonTree.png'
...
<svg width="750px" height="306px" viewBox="0 0 750 306" version="1.1" xmlns="http://www.w3.org/2000/svg" >
    <g id="Embed-SVG-to-Generate" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        ...
        <text id="CO2-Offset" className={ ibm.className } fontSize="80" fontWeight="normal" line-spacing="70" fill="#0A0615">
            <tspan x="42" y="130">CO2</tspan>
            <tspan x="60" y="211.568237" fontSize="48">Offset</tspan>
        </text>
        <a href={`https://c-labs.vercel.app/${query.address}`} target="_blank">
        ...
        <text id="2,365-Tons" className={ ibm.className } fontSize="80" fontWeight="normal" line-spacing="70" fill="#0A0615">
